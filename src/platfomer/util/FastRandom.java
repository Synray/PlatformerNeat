 ...
 * Threadsafe can be nice for convenient utility functions; use java.util.Random for that.
...
public class FastRandom implements Serializable
{
    ...
    public static final int SEED_SIZE_BYTES = 20; // Needs 5 32-bit integers.
     ...
     */
    private static synchronized byte[] seedFromTimeHost()
    {
    ...
    private static byte[] seedFromString(String s)
    {
